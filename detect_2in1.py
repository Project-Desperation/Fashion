...
thing_classes = ['short sleeve top', 'long sleeve top', 'short sleeve outwear', 'long sleeve outwear', 'vest',
                 ...
                 'sling dress']
URL = 'https://img.alicdn.com/imgextra/https://img.alicdn.com/imgextra/i3/1794440690/O1CN01SRoVqE1Gy3qIiYjjT_!!1794440690.jpg'


def detect_2in1(URL, thing_classes):
    # **********************************************************************************************************************
    # Detectron part
    # data registration
    ...
    with open('static/target_img', 'wb') as f:
        f.write(resp.content)

    # im = np.asarray(bytearray(resp.content), dtype="uint8")
    # im = cv2.imdecode(im, cv2.IMREAD_COLOR)
    # mx_im = mx.image.imdecode(im, cv2.IMREAD_COLOR)
    ...
    # get local image
    im = cv2.imread("static/target_img")
    mx_im = mx.image.imread("static/target_img")
    ...
    return  pred_boxes, scores, pred_classes, attr_predicts

pred_boxes, scores, pred_classes, attr_predicts = detect_2in1(URL, thing_classes)
print("pred_boxes: {}\nscores: {}\npred_classes: {}\nattr_predicts: {}\n".format(pred_boxes, scores, pred_classes, attr_predicts))